 ...
 * @return void.
 */
void Utils::BufferAppendFloat16(uint8_t* buffer, float number, float scale,
                                int32_t* index) {
 ...
 * @return void.
 */
void Utils::BufferAppendFloat32(uint8_t* buffer, float number, float scale,
                                int32_t* index) {
 ...
 *
 * This function takes a geographic coordinate in the form of a latitude,
 * longitude, and altitude, and converts it to Earth-Centered, Earth-Fixed
 * (ECEF) coordinates. The ECEF coordinate system is a Cartesian coordinate
 * system used to describe the 3D position of objects in space.
 * https://en.wikipedia.org/wiki/Earth-centered,_Earth-fixed_coordinate_system
 *
 * @param point A structure containing the geographic coordinate (latitude,
 * longitude, altitude) to be converted.
 *
 * @return A 3D vector representing the ECEF coordinates of the input geographic
 * coordinate. The x-coordinate corresponds to the north direction, the
 * y-coordinate corresponds to the east direction, and the z-coordinate
 ...
 *
 * This function takes a point in Earth-Centered, Earth-Fixed (ECEF) coordinates
 * and converts it to a geographical coordinate in the form of a latitude,
 * longitude, and altitude.
 * https://en.wikipedia.org/wiki/Earth-centered,_Earth-fixed_coordinate_system
 *
 * @param point A 3D vector representing the ECEF coordinates of the input
 * geographic coordinate. The x-coordinate corresponds to the north direction,
 * the y-coordinate corresponds to the east direction, and the z-coordinate
 * corresponds to the up direction.
 *
...
/**
 * @brief Converts a geographic coordinate (latitude, longitude, altitude) to
 * Local Tangent Plane (LTP) coordinates.
 *
 * This function takes a geographic coordinate in the form of a latitude,
 * longitude, and altitude, and converts it to Local Tangent Plane (LTP)
 * coordinates. The LTP coordinate system is a Cartesian coordinate system used
 * to describe the 3D position of objects relative to a reference point.
 * https://en.wikipedia.org/wiki/Local_tangent_plane_coordinates
 *
 * @param geo A structure containing the geographic coordinate (latitude,
 * longitude, altitude) to be converted.
 * @param geoOrigin A structure containing the geographic coordinate (latitude,
 * longitude, altitude) of the reference point.
 *
 * @return A 3D vector representing the LTP coordinates of the input geographic
 * coordinate. The x-coordinate corresponds to the north direction, the
...
/**
 * @brief Converts a Local Tangent Plane (LTP) coordinates to a geographic
 ...
 * https://en.wikipedia.org/wiki/Local_tangent_plane_coordinates
 *
 * @param pos A 3D vector representing the LTP coordinates of the input
 * geographic coordinate. The x-coordinate corresponds to the north direction,
 * the y-coordinate corresponds to the west direction, and the z-coordinate
 * corresponds to the up direction.
 * @param geoOrigin A structure containing the geographic coordinate (latitude,
 * longitude, altitude) of the reference point.
 *
